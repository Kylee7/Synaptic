...
LABEL name="synaptic"
LABEL version="1.0.0"
LABEL description="Synaptic - Decentralized AI Memory Connection Protocol"
LABEL maintainer="Synaptic Team <team@synapticmcp.xyz>"
LABEL org.opencontainers.image.title="Synaptic"
LABEL org.opencontainers.image.description="Decentralized AI Memory Connection Protocol"
